...
$lang = array_merge($lang, [
	...
	'ADVANCEDHIDE_ENABLE_CAPTCHA_EXPLAIN'  => 'Использовать стандартный плагин капчи форума при вводе пароля. <a href="%s">Настроить капчу</a>',
	...
	'ADVANCEDHIDE_CAPTCHA_LINK'            => 'Настроить капчу',
	'ADVANCEDHIDE_PERMISSIONS_LINK'        => 'Настроить права',
]);