...
$lang = array_merge($lang, [
	...
	'HIDE_BANNED_FROM_BLOCK'            => 'Вам заблокирован доступ к этому скрытому блоку.',
	'HIDE_NO_POST_AUTH'                 => 'У вас нет прав на использование тега [hide] в этом сообщении.',
	'HIDE_ERROR_NO_PERMISSION'          => 'У вас нет прав на использование тега [hide] в этом сообщении.',
	'HIDE_NO_PASS_AUTH'                 => 'У вас нет прав на установку паролей на скрытые блоки.',
	'HIDE_BAN_SUCCESS'                  => 'Пользователь успешно заблокирован для этого блока.',
	'HIDE_REPORT_SUBMITTED'             => 'Жалоба на брутфорс успешно отправлена.',
	'HIDE_APPEAL_SUBMITTED'             => 'Апелляция успешно отправлена на рассмотрение.',
	'HIDE_COND_NOT_GROUPS_FAILED'       => 'Вы состоите в исключённой группе.',
	'HIDE_COND_NOT_USERS_FAILED'        => 'Контент персонально скрыт для вашей учетной записи.',
	'LOG_ADVHIDE_BAN_USER'              => '<strong>Заблокирован доступ к скрытому блоку</strong><br />» Пользователь ID: %1$s (Сообщение: %2$s, Блок: %3$s)',
	'ADVHIDE_APPEAL_REJECTED'           => 'Апелляция отклонена.',
	'ADVHIDE_STATUS_REJECTED'           => 'Отклонено',
	'ADVHIDE_ACCEPT_APPEAL'             => 'Принять апелляцию',
	'ADVHIDE_REJECT_APPEAL'             => 'Отклонить апелляцию',
	...
	'FLOOD_ERROR'                       => 'Вы не можете выполнить это действие так быстро. Пожалуйста, подождите немного.',
]);